...
Proof.
unfold b2z; simpl.
destruct (Digit.eq_dec 0 1) as [H1 | H1]; [ idtac | reflexivity ].
discr_digit H1.
Qed.
...
Proof.
unfold b2z; simpl.
destruct (Digit.eq_dec 1 1) as [H1 | H1]; [ reflexivity | idtac ].
...
destruct s1 as [j1| ].
 ...
 destruct s2 as [j2| ].
  ...
  destruct s3 as [dj3| ].
   ...
   symmetry in Hs3.
   exfalso; revert Hs3; apply Digit.no_fixpoint_opp.
...
destruct (lt_eq_lt_dec dx dy) as [[H1| H1]| H1].
 ...
 destruct H as [(Hyx, Hxx)| (Hyx, Hxx)]; simpl in Hyx, Hxx.
  ...
  destruct dx.
   ...
   destruct s3 as [di3| ]; [ idtac | discr_digit Hc3 ].
     ...
     destruct di3.
      ...
      destruct (lt_eq_lt_dec di1 di3) as [[H2| H2]| H2].
       ...
       destruct (lt_eq_lt_dec di1 dx) as [[H3| H3]| H3].
        ...
        apply Hny in H.
        rewrite Hy1 in H; discr_digit H.

        subst di1.
        rewrite Htx in Hc1; discr_digit Hc1.
    ...
    destruct (eq_nat_dec dy (S dx)) as [H2| H2].
     ...
     destruct di3.
      ...
      destruct (lt_eq_lt_dec di3 dx) as [[H2| H2]| H2].
       ...
       rewrite <- Hn1 in H.
       rewrite Htx in H; discr_digit H.

     pose proof (Hyx O) as H.
     rewrite Nat.add_1_r in H.
     rewrite Hny in H; [ discr_digit H | idtac ].
 ...
 destruct s1 as [di1| ]; [ simpl in Hc1 | clear Hc1 ].
  ...
  destruct di1.
   ...
   destruct di3.
    destruct dx.
     ...
     rewrite Ht3 in Htx; discr_digit Htx.
    ...
    destruct (lt_eq_lt_dec di1 di3) as [[H1| H1]| H1].
     ...
     destruct H as [(Hyx, Hxx)| (Hyx, Hxx)]; simpl in Hyx, Hxx.
      ...
      destruct s2 as [di2| ]; [ idtac | revert Hc4; apply Digit.neq_1_0 ].
      apply fst_same_sym_iff in Hs2; simpl in Hs2.
      ...
      destruct di2.
       ...
       rewrite Digit.add_assoc, Digit.add_nilpotent, Digit.add_0_l in H.
     ...
     destruct H as [(Hxy, Hyy)| (Hxy, Hyy)]; simpl in Hxy, Hyy.
      ...
      rewrite carry_before_inf_relay in H.
       rewrite carry_before_relay with (di := O) in H.
        rewrite Nat.add_0_r, Hc3 in H; discr_digit H.
      ...
      rewrite Nat.add_sub_assoc in H; [ idtac | assumption ].
      rewrite Nat.add_comm, Nat.add_sub in H.
      rewrite Hc1 in H; discr_digit H.
  ...
  destruct H as [(Hxy, Hyy)| (Hxy, Hyy)]; simpl in Hxy, Hyy.
   destruct di3.
    simpl in Hxy; rewrite Hxy in Htx.
    discr_digit Htx.
   ...
   destruct di3.
    ...
    rewrite carry_before_inf_relay in Hc4; [ discr_digit Hc4 | idtac ].
    apply fst_same_iff; simpl.
    intro j.
    unfold I_add_i.
    destruct (lt_eq_lt_dec j (S di3)) as [[H1| H1]| H1].
     rewrite Hn3; [ idtac | assumption ].
     rewrite Digit.opp_add_diag_l.
     ...
     subst j.
     rewrite Hyy, Digit.add_1_l.
     rewrite <- Hxz, Hxy, Digit.add_0_l.
     unfold carry.
 ...
 destruct H as [(Hxy, Hyy)| (Hxy, Hyy)]; simpl in Hxy, Hyy.
  ...
  destruct (lt_dec (S dy) dx) as [H2| H2].
   ...
   unfold carry in Hc3; simpl in Hc3.
   remember (fst_same y z 0) as s3 eqn:Hs3 .
   destruct s3 as [dj3| ]; [ idtac | discr_digit Hc3 ].
   generalize Hs3; intros H.
   apply fst_same_sym_iff in H; simpl in H.
   ...
   destruct (lt_eq_lt_dec dj3 dy) as [[H1| H1]| H1].
    ...
    destruct s1 as [dj1| ]; [ idtac | clear Hc1 ].
     ...
     destruct (lt_eq_lt_dec dj1 dy) as [[H1| H1]| H1].
      ...
      subst dj1.
      rewrite Ht3 in Ht1; discr_digit Ht1.
     ...
     destruct s4 as [di4| ]; [ idtac | discr_digit Hc4 ].
     apply fst_same_sym_iff in Hs4; simpl in Hs4.
     destruct Hs4 as (Hn4, _).
     destruct di4.
      unfold I_add_i in Hc4.
      destruct dy.
       rewrite Hc3, Ht3, Digit.add_0_l in Hc4.
       unfold carry in Hc4; simpl in Hc4.
       remember (fst_same y z 1) as s5 eqn:Hs5 .
       destruct s5 as [dj5| ]; [ idtac | discr_digit Hc4 ].
       simpl in Hyy; rewrite Hyy in Hc4; discr_digit Hc4.
       ...
       destruct s5 as [dj5| ]; [ idtac | clear Hc4 ].
        ...
        destruct (lt_eq_lt_dec dj5 dy) as [[H1| H1]| H1].
         ...
         apply Nat.succ_lt_mono in H.
         apply Hn3 in H.
         rewrite Ht5, Hc4 in H; discr_digit H.

         subst dj5.
         rewrite Hc3 in Hc4; discr_digit Hc4.

         rewrite Hn5 in Hty; [ idtac | assumption ].
         rewrite Ht3 in Hty; discr_digit Hty.
      ...
      destruct dy.
       simpl in Hxy, Hyy.
       rewrite Hyy, <- Ht1, Hxy, Digit.add_0_l in Hc4.
       unfold carry in Hc4; simpl in Hc4.
       remember (fst_same y z (S (S di4))) as s5 eqn:Hs5 .
       destruct s5 as [dj5| ]; [ idtac | discr_digit Hc4 ].
       rewrite Hyy in Hc4; discr_digit Hc4.
       ...
       destruct (lt_eq_lt_dec di4 dy) as [[H1| H1]| H1].
        ...
        subst di4.
        rewrite Hty, Ht3, Digit.add_0_l in Hc4.
        ...
        rewrite carry_before_relay with (di := O) in Hc4.
         ...
         split.
          ...
          symmetry; rewrite Hyy, <- Digit.opp_involutive.
...
unfold carry in Hc1; simpl in Hc1.
remember (fst_same x z 0) as s1 eqn:Hs1 .
destruct s1 as [dj1| ]; [ idtac | discr_digit Hc1 ].
generalize Hs1; intros H.
apply fst_same_sym_iff in H; simpl in H.
...
destruct (lt_eq_lt_dec dj1 dx) as [[H1| H1]| H1].
 ...
 destruct s2 as [dj2| ]; [ idtac | clear Hc2 ].
  ...
  rewrite Ht2 in Hc2; discr_digit Hc2.

  assert (∀ dj, (I_add_i x z (0 + dj) = 1)%D) as H.
   intros dj; simpl; apply Hs2.

   destruct dj1; [ revert H1; apply Nat.nlt_0_r | idtac ].
   pose proof (Hn1 O (Nat.lt_0_succ dj1)) as HH.
   apply I_add_inf_1_neq_if in H; [ idtac | assumption ].
   simpl in H.
   ...
   destruct (lt_eq_lt_dec j dx) as [[H2| H2]| H2].
    ...
    rewrite Hzj in Hxj; discr_digit Hxj.

    subst j.
    rewrite Hz1 in Hzj; discr_digit Hzj.

    destruct (lt_eq_lt_dec (S dj1) j) as [[H3| H3]| H3].
     generalize H3; intros H.
     apply Hxz in H.
     rewrite Hc1, Ht1 in H; discr_digit H.
     ...
     destruct (lt_eq_lt_dec dx dy) as [[H2| H2]| H2].
      ...
      unfold carry in Hc4; simpl in Hc4.
      remember (fst_same (y + z) 0 0) as s4 eqn:Hs4 .
      destruct s4 as [dj4| ]; [ idtac | discr_digit Hc4 ].
      ...
      destruct (lt_eq_lt_dec dj3 dx) as [[H2| H2]| H2].
       ...
       subst dj3.
       rewrite Hz1 in Ht3; discr_digit Ht3.
       ...
       destruct (lt_eq_lt_dec dj3 (S dj1)) as [[H3| H3]| H3].
        ...
        rewrite Hx3, Hc3, Digit.add_1_l, Digit.add_0_l in H.
        unfold carry in H; simpl in H.
        ...
        destruct sx3 as [dx3| ].
         ...
         destruct sy3 as [dy3| ].
          ...
          rewrite Htx3, Hty3 in H; discr_digit H.
         ...
         destruct sy3 as [dy3| ]; [ idtac | discr_digit H ].
         destruct Hsy3 as (Hny3, Hty3).
         clear H.
         generalize Hx3; intros H.
         eapply I_eq_neq_prop in H; try eassumption.
        ...
        destruct dj4.
         ...
         destruct s5 as [dj5| ]; [ idtac | clear Hc4 ].
          ...
          destruct (lt_eq_lt_dec dj5 dj1) as [[H3| H3]| H3].
           ...
           apply Nat.succ_lt_mono in H.
           rewrite Hn3 in Hc4; [ idtac | assumption ].
           rewrite Ht5 in Hc4; discr_digit Hc4.

           subst dj5.
           rewrite Ht3 in Ht5; discr_digit Ht5.

           generalize H3; intros H.
           rewrite Hn5 in Hc3; [ idtac | assumption ].
           rewrite Ht3 in Hc3; discr_digit Hc3.
         ...
         destruct (lt_eq_lt_dec dj4 dj1) as [[H3| H3]| H3].
          ...
          destruct s5 as [dj5| ]; [ idtac | clear Hc4 ].
           ...
           destruct (lt_eq_lt_dec (S (dj4 + dj5)) dj1) as [[H4| H4]| H4].
            ...
            rewrite H4, Ht1 in Ht5; discr_digit Ht5.
            ...
            destruct dj5.
             ...
             rewrite Nat.add_sub_assoc in H; [ idtac | assumption ].
             rewrite Nat.add_comm, Nat.add_sub in H.
             rewrite Ht1, Hc3 in H; discr_digit H.
          ...
          rewrite Hzd in Ht5; discr_digit Ht5.

          unfold I_add_i in Hc4.
          destruct (Digit.dec (y.[S dj4])) as [Hy4 | Hy4]; rewrite Hy4 in *.
           pose proof (Hzd (dj4 - S dj1)%nat) as H.
           rewrite Nat.add_succ_r in H.
           rewrite Nat.add_sub_assoc in H; [ idtac | assumption ].
           rewrite Nat.add_comm, Nat.add_sub in H.
           rename H into Hz4.
           rewrite Hz4, Digit.add_nilpotent, Digit.add_0_l in Hc4.
           unfold carry in Hc4.
           remember (fst_same y z (S (S dj4))) as s5 eqn:Hs5 .
           destruct s5 as [dj5| ]; [ idtac | discr_digit Hc4 ].
           apply fst_same_sym_iff in Hs5; simpl in Hs5.
           ...
           rewrite Nat.add_sub_assoc in H; [ idtac | omega ].
           rewrite Nat.add_comm, Nat.add_sub in H.
           rewrite Ht5 in H; discr_digit H.
           ...
           destruct H as [(Hyx, Hxx)| (Hyx, Hxx)]; simpl in Hyx, Hxx.
            ...
            do 2 rewrite Digit.add_0_l in H.
            unfold carry in H; simpl in H.
            ...
            destruct s5 as [dj5| ].
             ...
             destruct Hs5 as (Hn5, Ht5).
             rewrite <- Nat.add_succ_r, <- Nat.add_succ_l in Ht5.
             rewrite Hxd in Ht5; discr_digit Ht5.
             ...
             destruct s6 as [dj6| ]; [ idtac | clear H ].
              ...
              rewrite Nat.add_sub_assoc in H; [ idtac | assumption ].
              rewrite Nat.add_comm, Nat.add_sub in H.
              rewrite Hy4 in H; discr_digit H.
            ...
            rewrite Hyx in H; discr_digit H.

        pose proof (Hzd (dj3 - S (S dj1))%nat) as H.
        rewrite Nat.add_succ_r, <- Nat.add_succ_l in H.
        rewrite Nat.add_sub_assoc in H; [ idtac | assumption ].
        rewrite Nat.add_comm, Nat.add_sub in H.
        rewrite Ht3 in H; discr_digit H.
 ...
 destruct (lt_eq_lt_dec dx dy) as [[H1| H1]| H1].
   ...
   destruct (lt_dec (S dx) dy) as [H2| H2].
    ...
    destruct s2 as [dj2| ]; [ idtac | clear Hc2 ].
     ...
     assert (∀ dj, (I_add_i x z (0 + dj) = 1)%D) as H.
      ...
      destruct dx.
       rewrite <- Ht1 in Hc1.
       apply I_add_inf_1_eq_if in H; [ idtac | assumption ].
       ...
       rewrite Hc3 in Ht3; symmetry in Ht3.
       destruct dj3.
        rewrite Hc3 in Hy1; discr_digit Hy1.

        rewrite Hyd in Ht3; discr_digit Ht3.
       ...
       destruct (lt_eq_lt_dec j (S dx)) as [[H1| H1]| H1].
        ...
        rewrite Ht1 in Hc1; discr_digit Hc1.
  ...
  destruct s2 as [dj2| ]; [ idtac | clear Hc2 ].
   ...
   assert (∀ dj, (I_add_i x z (dx + dj) = 1)%D) as H.
    intros dj; apply Hs2.
    ...
    destruct s5 as [dj5| ].
     ...
     destruct s6 as [dj6| ]; [ idtac | clear H ].
      ...
      rewrite Hs6 in H; discr_digit H.
      ...
      destruct (lt_eq_lt_dec dj4 dx) as [[H1| H1]| H1].
       ...
       rewrite carry_before_relay with (di := (dx - S dj4)%nat) in Hc4.
        ...
        rewrite Hty in Hc4; discr_digit Hc4.
       ...
       subst dj4.
       unfold I_add_i in Hc4; simpl in Hc4.
       rewrite Hty, Ht1, Digit.add_0_l in Hc4.
       ...
       rewrite carry_before_relay with (di := O) in Hc4.
        ...
        rewrite Hs6 in Hc4; discr_digit Hc4.
  ...
  destruct H as [(Hyx, Hxx)| (Hyx, Hxx)]; simpl in Hyx, Hxx.
   ...
   destruct (lt_dec (S dy) dx) as [H2| H2].
    ...
    destruct s2 as [dj2| ]; [ idtac | clear Hc2 ].
     ...
     assert (∀ dj, (I_add_i x z (S dy + dj) = 1)%D) as H.
      intros dj; apply Hs2.
...
destruct dx; [ clear Hnx | idtac ].
 ...
 destruct H as [(Hyx, Hxx)| (Hyx, Hxx)]; simpl in Hyx, Hxx.
  ...
  rewrite Z.add_assoc; f_equal.
  destruct (Digit.dec c1) as [H|H]; rewrite H in *; clear c1 H.
   destruct (Digit.dec c2) as [H|H]; rewrite H in *; clear c2 H.
    destruct (Digit.dec c3) as [H|H]; rewrite H in *; clear c3 H.
     destruct (Digit.dec c4) as [H|H]; rewrite H in *;
    ...
    destruct (Digit.dec c3) as [H|H]; rewrite H in *; clear c3 H.
     destruct (Digit.dec c4) as [H|H]; rewrite H in *;
     try rewrite b2z_0; try rewrite b2z_1; try reflexivity; exfalso.
      unfold carry in Hc1; simpl in Hc1.
      remember (fst_same x z 0) as s1 eqn:Hs1 .
      apply fst_same_sym_iff in Hs1; simpl in Hs1.
      destruct s1 as [dj1| ]; [ idtac | clear Hc1 ].
       rewrite Hxx in Hc1; discr_digit Hc1.

       unfold carry in Hc4; simpl in Hc4.
       remember (fst_same (y + z) 0 0) as s4 eqn:Hs4 .
       destruct s4 as [dj4| ]; [ idtac | discr_digit Hc4 ].
       unfold I_add_i in Hc4; simpl in Hc4.
       rewrite Hny, <- Hs1, Hxx, Digit.add_0_l in Hc4.
       unfold carry in Hc4; simpl in Hc4.
       remember (fst_same y z (S dj4)) as s5 eqn:Hs5 .
       destruct s5 as [dj5| ]; [ idtac | discr_digit Hc4 ].
       rewrite Hny in Hc4; discr_digit Hc4.
    ...
    destruct (Digit.dec c3) as [H|H]; rewrite H in *; clear c3 H.
     ...
     try rewrite b2z_0; try rewrite b2z_1; try reflexivity; clear H; exfalso.
      ...
      destruct s2 as [dj2| ]; [ idtac | clear Hc2 ].
       ...
       destruct s1 as [dj1| ]; [ idtac | discr_digit Hc1 ].
       destruct Hs1 as (Hn1, Ht1).
       assert (∀ dj, (I_add_i x z (dj1 + dj) = 1)%D) as H.
        intros dj; apply Hs2.

        apply I_add_inf_1_eq_if in H; [ idtac | assumption ].
        destruct H as (Hx1, _).
        pose proof (Hxx (dj1 + 1)%nat) as H.
        rewrite Hx1 in H; discr_digit H.
    ...
    destruct (Digit.dec c3) as [H|H]; rewrite H in *; clear c3 H.
     ...
     try rewrite b2z_0; try rewrite b2z_1; try reflexivity; clear H; exfalso.
      ...
      destruct s4 as [dj4| ]; [ idtac | clear Hc4 ].
       ...
       rewrite Ht4 in Hc4; discr_digit Hc4.
       ...
       destruct s3 as [dj3| ]; [ idtac | clear Hc3 ].
        ...
        assert (∀ dj, (I_add_i y z (dj3 + dj) = 1)%D) as H.
         intros dj; apply Hs4.
         ...
         unfold carry in Hc2; simpl in Hc2.
         remember (fst_same (x + z) 0 0) as s2 eqn:Hs2 .
         destruct s2 as [dj2| ]; [ idtac | discr_digit Hc2 ].
         apply fst_same_sym_iff in Hs2; simpl in Hs2.
         destruct Hs2 as (Hn2, _).
         unfold I_add_i in Hc2; simpl in Hc2.
         destruct dj3.
          destruct dj1.
           rewrite Hc1, <- Ht3, Hc3 in Ht1; discr_digit Ht1.

           simpl in Hz3.
           rewrite Hz3, Hc1 in Ht1; discr_digit Ht1.
          ...
          unfold carry in H.
          remember (fst_same y z 1) as s5 eqn:Hs5 .
          destruct s5 as [dj5| ]; [ idtac | discr_digit H ].
          rewrite Hny in H; discr_digit H.

        pose proof (Hs4 O) as H.
        unfold I_add_i in H.
        rewrite Hs3, Digit.opp_add_diag_l, Digit.add_1_l in H.
        apply Digit.opp_1_iff in H.
        unfold carry in H; simpl in H.
        remember (fst_same y z 1) as s5 eqn:Hs5 .
        destruct s5 as [dj5| ]; [ idtac | discr_digit H ].
 ...
 destruct H as [(Hyx, Hxx)| (Hyx, Hxx)]; simpl in Hyx, Hxx.
  ...
  symmetry in H.
  rewrite Digit.opp_0, Digit.add_1_l in H.
  ...
  destruct s1 as [dj1| ].
   ...
   simpl in H.
   rewrite Ht1 in H.
   destruct s2 as [dj2| ]; [ idtac | discr_digit H ].
   rewrite Hny in H; discr_digit H.

   apply fst_same_sym_iff in Hs1; simpl in Hs1.
   rewrite Hs1 in Htx; discr_digit Htx.
...
destruct s2 as [dj2| ]; [ idtac | clear Hc2 ].
 ...
 destruct Hs4 as (Hn4, _).
 unfold I_add_i in Hc4.
 rewrite Hny, Digit.add_1_l in Hc4.
 destruct (Digit.dec (z.[dj4])) as [Hz4 | Hz4]; rewrite Hz4 in *.
  rewrite Digit.add_0_l in Hc4.
  unfold carry in Hc4.
  remember (fst_same y z (S dj4)) as s5 eqn:Hs5 .
  destruct s5 as [dj5| ]; [ idtac | discr_digit Hc4 ].
...
destruct (Digit.dec c3) as [H|H]; rewrite H in *; clear c3 H.
 destruct (Digit.dec c4) as [H|H]; rewrite H in *; clear c4 H.
  destruct (Digit.dec c5) as [H|H]; rewrite H in *; clear c5 H.
   destruct (Digit.dec c6) as [H|H]; rewrite H in *;
   try rewrite b2z_0; try rewrite b2z_1; try reflexivity; clear H; exfalso.
   eapply case_1; eassumption.
...
Definition R_compare x y :=
  ...
  | Eq =>
      ...
      | Some j => if Digit.dec ((R_frac nx)%R.[j]) then Gt else Lt
      | None => Eq
      end
  | Lt => Lt
  | Gt => Gt
...
split; intros H.
 ...
 destruct s1 as [dj1| ].
  destruct (Digit.dec (R_frac nx .[ dj1])); discriminate H.
...
destruct c; simpl.
 ...
 destruct s1 as [j1| ].
  ...
  apply eq_digit_eq in Hx0.
  symmetry in Hx0; apply Digit.opp_sym in Hn1.
  destruct s2 as [j2| ].
   destruct Hs2 as (Hs2, Hn2).
   remember (I_add_i (R_frac y) 0 j2) as y0 eqn:Hy0 .
   apply eq_digit_eq in Hy0.
   symmetry in Hy0; apply Digit.opp_sym in Hn2.
   destruct (lt_eq_lt_dec j1 j2) as [[H1| H1]| H1].
    apply Hs2 in H1.
    rewrite Digit.opp_involutive, Hn1 in H1.
    rewrite Hx0 in H1.
    exfalso; revert H1; apply Digit.no_fixpoint_opp.

    subst j2.
    destruct (Digit.dec x0) as [H|H]; rewrite H in *; clear x0 H.
     split; intros H; [ clear H | reflexivity ].
     destruct (Digit.dec y0) as [H|H]; [ exfalso | reflexivity ].
     rewrite H in *; clear y0 H.
     rewrite Hx0 in Hn2; discr_digit Hn2.

     split; intros H; [ discriminate H | exfalso ].
     destruct (Digit.dec y0) as [H1 | H1]; [ discriminate H | clear H ].
     rewrite H1 in *; clear y0 H1.
     rewrite Hx0 in Hn2; discr_digit Hn2.
   ...
   destruct (Digit.dec x0) as [H1 | H1]; [ clear H | discriminate H ].
   rewrite H1 in *; clear x0 H1.
   rewrite Hs2, Hx0 in Hn1; discr_digit Hn1.
...
destruct c; simpl in Hyx.
 ...
 destruct sx as [dx| ]; [ idtac | clear Hxy ].
  ...
  apply eq_digit_eq in Hxb.
  symmetry in Hxb; apply Digit.opp_sym in Htx.
  destruct sy as [dy| ]; [ idtac | clear Hyx ].
   ...
   symmetry in Hyb; apply Digit.opp_sym in Hty.
   remember (Digit.dec xb) as u.
   destruct u as [H|H]; [ exfalso; apply Hxy; reflexivity | clear Hequ ].
   rewrite H in *; clear xb H Hxy.
   remember (Digit.dec yb) as u.
   destruct u as [H|H]; [ exfalso; apply Hyx; reflexivity | clear Hequ ].
   rewrite H in *; clear yb H Hyx.
   destruct (lt_eq_lt_dec dx dy) as [[H1| H1]| H1].
    generalize H1; intros H.
    apply Hny in H.
    rewrite Htx, Hxb in H; discr_digit H.

    subst dy.
    rewrite Hxb in Hty; discr_digit Hty.

    generalize H1; intros H.
    apply Hnx in H.
    rewrite Hty, Hyb in H; discr_digit H.

   rewrite Hsy, Hxb in Htx.
   exfalso; revert Htx; apply Digit.no_fixpoint_opp.

  destruct sy as [dy| ]; [ idtac | clear Hyx ].
   destruct Hsy as (Hny, Hty).
   simpl in Hyx.
   rewrite Hsx in Hty.
   rewrite Digit.opp_involutive in Hty.
   symmetry in Hty.
   exfalso; revert Hty; apply Digit.no_fixpoint_opp.

   unfold R_eq; simpl.
   apply Z.compare_eq in Hc; simpl in Hc.
   split; [ assumption | idtac ].
   unfold I_eq; intros i; simpl.
   rewrite Hsx, Digit.opp_involutive; reflexivity.
...
destruct cxz; [ idtac | intros H; discriminate H | exfalso ].
 ...
 apply eq_digit_eq in Hbxz.
 destruct (Digit.dec bxz) as [H|H]; [ exfalso | intros H1; discriminate H1 ].
 rewrite H in *; clear bxz H.
 symmetry in Hbxz; apply Digit.opp_sym in Htxz; simpl in Htxz.
 destruct cxy; [ idtac | clear Hxy | apply Hxy; reflexivity ].
  ...
  destruct sxy as [dxy| ]; [ idtac | clear Hxy ].
   ...
   apply eq_digit_eq in Hbxy.
   destruct (Digit.dec bxy) as [H|H]; [ apply Hxy; reflexivity | clear Hxy ].
   rewrite H in *; clear bxy H.
   symmetry in Hbxy; apply Digit.opp_sym in Htxy; simpl in Htxy.
   destruct cyz; [ idtac | clear Hyz | apply Hyz; reflexivity ].
    ...
    destruct syz as [dyz| ]; [ idtac | clear Hyz ].
     ...
     remember (Digit.dec byz) as u.
     destruct u as [H|H]; [ apply Hyz; reflexivity | clear Hequ ].
     rewrite H in *; clear byz H.
     symmetry in Hbyz; apply Digit.opp_sym in Htyz; simpl in Htyz.
     destruct (lt_eq_lt_dec dxy dyz) as [[H1| H1]| H1].
      ...
      destruct (lt_eq_lt_dec dxy dxz) as [[H2| H2]| H2].
       generalize H2; intros H.
       apply Hnxz in H.
       rewrite Hbxy, <- Hz in H; discr_digit H.

       subst dxz.
       rewrite Hbxy in Hbxz; discr_digit Hbxz.
       ...
       apply Hnyz in H.
       rewrite H, Htxz in Hy; discr_digit Hy.

      subst dyz.
      rewrite Htxy in Hbyz; discr_digit Hbyz.
      ...
      destruct (lt_eq_lt_dec dyz dxz) as [[H2| H2]| H2].
       generalize H2; intros H.
       apply Hnxz in H.
       rewrite Hx, Htyz in H; discr_digit H.

       subst dxz.
       rewrite Htyz in Htxz; discr_digit Htxz.
       ...
       apply Hnxy in H.
       rewrite Hbxz, Hy in H; discr_digit H.

     rewrite Hny, Hnz in Hsyz; simpl in Hsyz.
     destruct (lt_eq_lt_dec dxy dxz) as [[H1| H1]| H1].
      generalize H1; intros H.
      apply Hnxz in H.
      rewrite Hbxy, <- Hsyz, Htxy in H; discr_digit H.
      ...
      generalize H1; intros H.
      apply Hnxy in H.
      rewrite Hbxz, Hsyz, Htxz in H; discr_digit H.
   ...
   destruct cyz; [ idtac | clear Hyz | apply Hyz; reflexivity ].
    ...
    destruct syz as [dyz| ]; [ idtac | clear Hyz ].
     ...
     destruct (lt_eq_lt_dec dyz dxz) as [[H1| H1]| H1].
      generalize H1; intros H.
      apply Hnxz in H.
      rewrite Hsxy, Hbyz, Htyz in H; discr_digit H.
      ...
      apply Digit.opp_sym in H.
      rewrite Htxz, <- Hsxy, Hbxz in H; discr_digit H.

     rewrite Hnx, Hny in Hsxy; simpl in Hsxy.
     rewrite Hny, Hnz in Hsyz; simpl in Hsyz.
     rewrite Hsxy, Hsyz, Htxz in Hbxz; discr_digit Hbxz.
...
destruct c.
 ...
 destruct s as [di| ].
  ...
  apply eq_digit_eq in Hxb.
  symmetry in Hxb; apply Digit.opp_sym in Ht.
  destruct (Digit.dec xb) as [H|H]; simpl in Ht; rewrite H in *; clear xb H.
...
destruct c; [ simpl in H | discriminate H | clear H ].
 ...
 apply eq_digit_eq in Hb1.
 destruct (Digit.dec b1) as [H1|H1]; [ clear H | discriminate H ].
 rewrite H1 in *; clear b1 H1.
 unfold I_add_i in Hb1; simpl in Hb1.
 rewrite carry_diag in Hb1; discr_digit Hb1.
 ...
 destruct Hc as [Hc| Hc].
  ...
  apply eq_digit_eq in Heqc.
  apply Z.nle_gt in Hc; apply Hc.
  destruct (Digit.dec c) as [H|H]; rewrite H in *; clear c H.
   rewrite b2z_1; apply Z.le_0_1.
...
Theorem R_zero_iff : ∀ x,
  (x = 0)%R
  ↔ (R_int x = 0 ∧ ∀ i : nat, ((R_frac x).[i] = 0)%D) ∨
    (R_int x = -1 ∧ ∀ i : nat, ((R_frac x).[i] = 1)%D).
Proof.
intros x.
split; intros Hx.
 unfold R_eq in Hx.
 ...
 destruct Hf as [Hf| Hf]; [ left | right ].
  split; [ idtac | assumption ].
  destruct s1 as [dj1| ].
   rewrite Hf, b2z_0, Z.add_0_r in Hi; assumption.

   pose proof (Hs1 O) as H.
   rewrite Hf in H; discr_digit H.

  split; [ idtac | assumption ].
  destruct s1 as [dj1| ].
   destruct Hs1 as (Hn1, Ht1).
   rewrite Hf in Ht1; discr_digit Ht1.

   simpl in Hi.
   apply Z.add_move_r in Hi.
   rewrite b2z_0, b2z_1 in Hi; assumption.
 ...
 destruct Hx as [(Hi, Hf)| (Hi, Hf)].
  ...
  split.
   ...
   apply fst_same_sym_iff in Hs1; simpl in Hs1.
   pose proof (Hf O) as H; rewrite Hs1 in H; discr_digit H.
  ...
  split.
   ...
   destruct s1 as [dj1| ].
    ...
    rewrite Hi, b2z_1, b2z_0; reflexivity.
...
split.
 ...
 rewrite <- Z.add_sub_assoc, Z.add_0_r; f_equal.
 rewrite carry_compat.
  reflexivity.
...
Theorem R_const_if : ∀ x b, (∀ i, (x.[i] = b)%D) → (x = 0)%I.
Proof.
intros x b H.
unfold I_eq; intros i; simpl.
unfold I_add_i; simpl.
rewrite H, Digit.add_0_r, carry_diag; simpl.
unfold carry; simpl.
remember (fst_same x 0 (S i)) as s1 eqn:Hs1 .
destruct s1 as [dj1| ].
 rewrite H, Digit.add_nilpotent; reflexivity.
...
split.
 ...
 apply fst_same_sym_iff in Hs4; simpl in Hs4.
 destruct s3 as [dj3| ].
  destruct Hs3 as (Hn3, Ht3); rewrite Ht3, b2z_0, Z.add_0_r.
  apply Digit.opp_0_iff in Ht3.
  destruct s4 as [dj4| ].
   destruct Hs4 as (Hn4, Ht4); rewrite Ht4, b2z_0, Z.add_0_r.
   ...
   apply fst_same_sym_iff in Hs2; simpl in Hs2.
   destruct s1 as [dj1| ].
    destruct Hs1 as (Hn1, Ht1); rewrite Ht1, b2z_0, Z.add_0_r in Hi.
    destruct s2 as [dj2| ].
     destruct Hs2 as (Hn2, Ht2); rewrite Ht2, b2z_0, Z.add_0_r in Hi.
     assumption.
     ...
     destruct Hf as [Hf| Hf].
      rewrite Hf in Ht3; discr_digit Ht3.
    ...
    destruct s2 as [dj2| ].
     ...
     apply I_zero_iff in Hf.
     destruct Hf as [Hf| Hf].
      rewrite Hf in Ht4; discr_digit Ht4.

      rewrite Hf in Ht2; discr_digit Ht2.
   ...
   assert (∀ dj, ((R_frac y) .[ dj] = 0)%D) as H.
    intros dj; apply Digit.opp_1_iff, Hs4.
    ...
    destruct s1 as [dj1| ].
     ...
     destruct s2 as [dj2| ].
      destruct Hs2 as (Hn2, Ht2).
      rewrite Ht2 in Hi.
      rewrite b2z_0, Z.add_0_r in Hi; assumption.

      pose proof (Hs4 O) as H.
      rewrite Hs2 in H; discr_digit H.

  assert (∀ dj, ((R_frac x) .[ dj] = 0)%D) as H.
   intros dj; apply Digit.opp_1_iff, Hs3.

   rewrite b2z_1, Z.sub_simpl_r.
   unfold Z.sub.
   ...
   destruct s1 as [dj1| ].
    ...
    destruct s2 as [dj2| ].
     ...
     destruct s4 as [dj4| ].
      ...
      rewrite Hi, b2z_1; reflexivity.

     destruct s4 as [dj4| ].
      destruct Hs4 as (Hn4, Ht4).
      pose proof (Hs3 dj1) as H.
      apply Digit.opp_1_iff in H.
      rewrite H, b2z_0, Z.add_0_r, b2z_1 in Hi.
      rewrite Ht4, b2z_0, Z.add_0_r; assumption.
...
destruct s1 as [dj1| ].
 destruct Hs1 as (Hn1, Ht1).
 rewrite Ht1, b2z_0, Z.add_0_r in Hf.
 destruct s2 as [dj2| ].
  destruct Hs2 as (Hn2, Ht2).
  rewrite Ht2, b2z_0, Z.add_0_r in Hf.
  apply Z.nlt_ge in Hyb.
  rewrite Hf in Hxb; contradiction.

  rewrite Hf, b2z_1 in Hxb.
  exfalso; revert Hxb Hyb; simpl; intros; omega.

 destruct s2 as [dj2| ].
  destruct Hs2 as (Hn2, Ht2).
  rewrite Ht2, b2z_0, Z.add_0_r, b2z_1 in Hf.
  ...
  rewrite Hi in Ht2; discr_digit Ht2.
...
split.
 ...
 destruct s2 as [dj2| ].
  ...
  destruct s1 as [dj1| ].
   destruct Hs1 as (Hn1, Ht1); rewrite Ht1, b2z_1, b2z_0; reflexivity.

   pose proof (Hs1 O) as H.
   rewrite Hy in H; discr_digit H.

 unfold I_eq; intros i; simpl.
 unfold I_add_i; simpl.
 do 2 rewrite Digit.add_0_r.
 rewrite Hy, Digit.add_1_l, Digit.add_0_l.
 unfold carry; simpl.
...
destruct s1 as [dj1| ].
 ...
 apply eq_digit_eq in Hxb.
 symmetry in Hxb; apply Digit.opp_sym in Ht1.
 destruct s2 as [dj2| ].
  destruct Hs2 as (Hn2, Ht2).
  ...
  destruct (lt_eq_lt_dec dj1 dj2) as [[H1| H1]| H1].
   ...
   rewrite Digit.opp_involutive in H1; symmetry in H1.
   exfalso; revert H1; apply Digit.no_fixpoint_opp.

   subst dj2.
   rewrite Hxb in Hyb.
   destruct (Digit.dec xb) as [H1|H1].
    destruct (Digit.dec yb) as [H2|H2]; [ reflexivity | idtac ].
    rewrite H1, H2 in Hyb; discr_digit Hyb.

    destruct (Digit.dec yb) as [H2|H2]; [ idtac | reflexivity ].
    rewrite H1, H2 in Hyb; discr_digit Hyb.
  ...
  rewrite Hfzt in Ht1; simpl in Ht1.
  rewrite Hs2 in Hxb.
  rewrite Ht1, Digit.opp_involutive in Hxb.
  exfalso; revert Hxb; apply Digit.no_fixpoint_opp.
...
destruct (R_dec x y) as [H1| H1].
 ...
 destruct (R_dec y z) as [H2| H2].
  ...
  generalize Hxy; intros Hxye.
  generalize Hyz; intros Hyze.
...
assert (y < z)%R as H.
 ...
 eapply R_lt_trans; eassumption.
Qed.

Theorem R_le_lt_trans : ∀ x y z, (x ≤ y)%R → (y < z)%R → (x < z)%R.
Proof.
intros x y z Hxy Hyz.
destruct (R_dec x y) as [H1| H1]; [ rewrite H1; assumption | idtac ].
assert (x < y)%R as H.
 unfold R_le in Hxy; unfold R_lt.
 remember (x ?= y)%R as c eqn:Hc.
 symmetry in Hc.
 destruct c; [ idtac | reflexivity | exfalso; apply Hxy; reflexivity ].
 apply R_compare_eq in Hc.
 contradiction.
