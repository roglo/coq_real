...
Proof.
unfold b2z; simpl.
destruct (digit_eq_dec 1 1) as [H1 | H1]; [ reflexivity | idtac ].
...
destruct s1 as [j1| ].
 ...
 destruct s2 as [j2| ].
  ...
  destruct s3 as [dj3| ].
   ...
   symmetry in Hs3.
   exfalso; revert Hs3; apply digit_no_fixpoint_opp.
   ...
   destruct di3.
    ...
    destruct (lt_eq_lt_dec di1 di3) as [[H1| H1]| H1].
     ...
     destruct H as [(Hyx, Hxx)| (Hyx, Hxx)]; simpl in Hyx, Hxx.
      ...
      destruct s2 as [di2| ]; [ idtac | revert Hc4; apply digit_neq_1_0 ].
      apply fst_same_sym_iff in Hs2; simpl in Hs2.
      ...
      destruct di2.
       ...
       rewrite digit_opp_add_diag_l, digit_add_1_l in Hc4.
       apply digit_opp_0_iff in Hc4.
       ...
       rewrite digit_add_assoc, digit_add_nilpotent, digit_add_0_l in H.
  ...
  destruct H as [(Hxy, Hyy)| (Hxy, Hyy)]; simpl in Hxy, Hyy.
   ...
   destruct di3.
    ...
    destruct (lt_eq_lt_dec j (S di3)) as [[H1| H1]| H1].
     ...
     rewrite digit_opp_add_diag_l.
     apply digit_opp_1_iff.
     unfold carry; simpl.
     ...
     subst j.
     rewrite Hyy, digit_add_1_l.
     rewrite <- Hxz, Hxy, digit_add_0_l.
     unfold carry.
   ...
   destruct (lt_eq_lt_dec dj3 dy) as [[H1| H1]| H1].
    ...
    destruct s1 as [dj1| ]; [ idtac | clear Hc1 ].
     ...
     destruct di4.
      unfold I_add_i in Hc4.
      destruct dy.
       rewrite Hc3, Ht3, digit_add_0_l in Hc4.
       unfold carry in Hc4; simpl in Hc4.
      ...
      destruct dy.
       simpl in Hxy, Hyy.
       rewrite Hyy, <- Ht1, Hxy, digit_add_0_l in Hc4.
       unfold carry in Hc4; simpl in Hc4.
     ...
     destruct (lt_eq_lt_dec dx dy) as [[H2| H2]| H2].
      ...
      destruct (lt_eq_lt_dec dj3 dx) as [[H2| H2]| H2].
       ...
       destruct (lt_eq_lt_dec dj3 (S dj1)) as [[H3| H3]| H3].
        ...
        rewrite Hx3, Hc3, digit_add_1_l, digit_add_0_l in H.
        unfold carry in H; simpl in H.
        ...
        destruct dj4.
         ...
         destruct (lt_eq_lt_dec dj4 dj1) as [[H3| H3]| H3].
          ...
          unfold I_add_i in Hc4.
          destruct (ddec (y.[S dj4])) as [Hy4 | Hy4]; rewrite Hy4 in *.
           pose proof (Hzd (dj4 - S dj1)%nat) as H.
           rewrite Nat.add_succ_r in H.
           rewrite Nat.add_sub_assoc in H; [ idtac | assumption ].
           rewrite Nat.add_comm, Nat.add_sub in H.
           rename H into Hz4.
           rewrite Hz4, digit_add_nilpotent, digit_add_0_l in Hc4.
           unfold carry in Hc4.
           remember (fst_same y z (S (S dj4))) as s5 eqn:Hs5 .
           destruct s5 as [dj5| ]; [ idtac | discr_digit Hc4 ].
           apply fst_same_sym_iff in Hs5; simpl in Hs5.
           ...
           destruct H as [(Hyx, Hxx)| (Hyx, Hxx)]; simpl in Hyx, Hxx.
            ...
            do 2 rewrite digit_add_0_l in H.
            unfold carry in H; simpl in H.
    ...
    destruct s5 as [dj5| ].
     ...
     destruct s6 as [dj6| ]; [ idtac | clear H ].
      ...
      destruct (lt_eq_lt_dec dj4 dx) as [[H1| H1]| H1].
       ...
       subst dj4.
       unfold I_add_i in Hc4; simpl in Hc4.
       rewrite Hty, Ht1, digit_add_0_l in Hc4.
...
destruct dx; [ clear Hnx | idtac ].
  ...
  destruct (ddec c1) as [H|H]; rewrite H in *; clear c1 H.
   destruct (ddec c2) as [H|H]; rewrite H in *; clear c2 H.
    destruct (ddec c3) as [H|H]; rewrite H in *; clear c3 H.
     destruct (ddec c4) as [H|H]; rewrite H in *; try reflexivity; exfalso.
    ...
    destruct (ddec c3) as [H|H]; rewrite H in *; clear c3 H.
     ...
     try rewrite b2z_0; try rewrite b2z_1; try reflexivity; exfalso.
      ...
      destruct s1 as [dj1| ]; [ idtac | clear Hc1 ].
       ...
       destruct s4 as [dj4| ]; [ idtac | discr_digit Hc4 ].
       unfold I_add_i in Hc4; simpl in Hc4.
       rewrite Hny, <- Hs1, Hxx, digit_add_0_l in Hc4.
       unfold carry in Hc4; simpl in Hc4.
     ...
     try rewrite b2z_0; try rewrite b2z_1; try reflexivity; clear H; exfalso.
      ...
      destruct s4 as [dj4| ]; [ idtac | clear Hc4 ].
       ...
       destruct s3 as [dj3| ]; [ idtac | clear Hc3 ].
        ...
        pose proof (Hs4 O) as H.
        unfold I_add_i in H.
        rewrite Hs3, digit_opp_add_diag_l, digit_add_1_l in H.
        apply digit_opp_1_iff in H.
        unfold carry in H; simpl in H.
        remember (fst_same y z 1) as s5 eqn:Hs5 .
        destruct s5 as [dj5| ]; [ idtac | discr_digit H ].
 ...
 destruct H as [(Hyx, Hxx)| (Hyx, Hxx)]; simpl in Hyx, Hxx.
  ...
  rewrite Hny, digit_add_1_l in H.
  symmetry in H.
  rewrite digit_opp_0, digit_add_1_l in H.
  apply oppd_sym in H.
...
Definition R_compare x y :=
  ...
  | Eq =>
      ...
      | Some j => if ddec ((R_frac nx)%R.[j]) then Gt else Lt
      | None => Eq
      end
  | Lt => Lt
  | Gt => Gt
...
split; intros H.
 ...
 destruct s1 as [dj1| ].
  destruct (ddec (R_frac nx .[ dj1])); discriminate H.
...
destruct c; simpl.
 ...
 destruct s1 as [j1| ].
  ...
  symmetry in Hx0; apply oppd_sym in Hn1.
  destruct s2 as [j2| ].
   ...
   destruct (lt_eq_lt_dec j1 j2) as [[H1| H1]| H1].
    ...
    subst j2.
    destruct (ddec x0) as [H|H]; rewrite H in *; clear x0 H.
     split; intros H; [ clear H | reflexivity ].
     destruct (ddec y0) as [H|H]; [ exfalso | reflexivity ].
     rewrite H in *; clear y0 H.
     rewrite Hx0 in Hn2; discr_digit Hn2.

     split; intros H; [ discriminate H | exfalso ].
     destruct (ddec y0) as [H1 | H1]; [ discriminate H | clear H ].
   ...
   destruct (ddec x0) as [H1 | H1]; [ clear H | discriminate H ].
...
destruct c; simpl in Hyx.
 ...
 destruct sx as [dx| ]; [ idtac | clear Hxy ].
  ...
  symmetry in Hxb; apply oppd_sym in Htx.
  destruct sy as [dy| ]; [ idtac | clear Hyx ].
   ...
   symmetry in Hyb; apply oppd_sym in Hty.
   destruct (ddec xb) as [H|H]; [ exfalso; apply Hxy; reflexivity | idtac ].
   rewrite H in *; clear xb H Hxy.
   destruct (ddec yb) as [H|H]; [ exfalso; apply Hyx; reflexivity | idtac ].
   ...
   exfalso; revert Htx; apply digit_no_fixpoint_opp.
  ...
  destruct sy as [dy| ]; [ idtac | clear Hyx ].
   ...
   symmetry in Hty.
   exfalso; revert Hty; apply digit_no_fixpoint_opp.
...
destruct cxz; [ idtac | intros H; discriminate H | exfalso ].
 ...
 destruct (ddec bxz) as [H|H]; [ exfalso | intros H1; discriminate H1 ].
 rewrite H in *; clear bxz H.
 symmetry in Hbxz; apply oppd_sym in Htxz; simpl in Htxz.
 destruct cxy; [ idtac | clear Hxy | apply Hxy; reflexivity ].
  ...
  destruct sxy as [dxy| ]; [ idtac | clear Hxy ].
   ...
   destruct (ddec bxy) as [H|H]; [ apply Hxy; reflexivity | clear Hxy ].
   rewrite H in *; clear bxy H.
   symmetry in Hbxy; apply oppd_sym in Htxy; simpl in Htxy.
   destruct cyz; [ idtac | clear Hyz | apply Hyz; reflexivity ].
    ...
    destruct syz as [dyz| ]; [ idtac | clear Hyz ].
     ...
     destruct (ddec byz) as [H|H]; [ apply Hyz; reflexivity | clear Hyz ].
     rewrite H in *; clear byz H.
     symmetry in Hbyz; apply oppd_sym in Htyz; simpl in Htyz.
...
destruct c.
 ...
 destruct s as [di| ].
  ...
  apply eq_digit_eq in Hxb.
  symmetry in Hxb; apply oppd_sym in Ht.
  destruct (ddec xb) as [H|H]; simpl in Ht; rewrite H in *; clear xb H.
...
destruct c; [ simpl in H | discriminate H | clear H ].
 ...
 destruct (ddec b1) as [H1|H1]; [ clear H | discriminate H ].
 ...
 destruct Hc as [Hc| Hc].
  ...
  destruct (ddec c) as [H|H]; rewrite H in *; clear c H.
...
rewrite H, digit_add_0_r, carry_diag; simpl.
unfold carry; simpl.
remember (fst_same x 0 (S i)) as s1 eqn:Hs1 .
destruct s1 as [dj1| ].
 rewrite H, digit_add_nilpotent; reflexivity.
 ...
 destruct s3 as [dj3| ].
  ...
  destruct s4 as [dj4| ].
   ...
   assert (∀ dj, ((R_frac y) .[ dj] = 0)%D) as H.
    intros dj; apply digit_opp_1_iff, Hs4.
  ...
  assert (∀ dj, ((R_frac x) .[ dj] = 0)%D) as H.
   intros dj; apply digit_opp_1_iff, Hs3.
...
split.
 ...
 rewrite Hy, digit_add_1_l, digit_add_0_l.
 unfold carry; simpl.
...
destruct s1 as [dj1| ].
 ...
 apply eq_digit_eq in Hxb.
 symmetry in Hxb; apply oppd_sym in Ht1.
 destruct s2 as [dj2| ].
  destruct Hs2 as (Hn2, Ht2).
  remember (yn .[ dj2]) as yb eqn:Hyb .
  apply eq_digit_eq in Hyb.
  symmetry in Hyb; apply oppd_sym in Ht2.
  subst xn yn zn tn.
  ...
  destruct (lt_eq_lt_dec dj1 dj2) as [[H1| H1]| H1].
   ...
   subst dj2.
   rewrite Hxb in Hyb.
   destruct (ddec xb) as [H1|H1].
    destruct (ddec yb) as [H2|H2]; [ reflexivity | idtac ].
    rewrite H1, H2 in Hyb; discr_digit Hyb.

    destruct (ddec yb) as [H2|H2]; [ idtac | reflexivity ].
    rewrite H1, H2 in Hyb; discr_digit Hyb.
  ...
  exfalso; revert Hxb; apply digit_no_fixpoint_opp.
