...
(* normalisation and equality of reals in interval [0..1[ *)
...
Proof. apply Nat.succ_pred, radix_neq_0. Qed.

Theorem radix_mod_radix : radix mod radix = 0.
Proof. apply Nat.mod_same, radix_neq_0. Qed.

Theorem zero_mod_radix : 0 mod radix = 0.
Proof. apply Nat.mod_small, radix_gt_0. Qed.

Theorem add_pred_radix_1_mod_radix : (pred radix + 1) mod radix = 0.
Proof.
rewrite Nat.add_1_r, succ_pred_radix, radix_mod_radix; reflexivity.
Qed.
...
Proof.
intros d; rewrite <- d2n_9.
split; intros H; [ idtac | subst d; reflexivity ].
...
destruct r; [ exfalso; revert Hr; apply radix_neq_0 | idtac ].
    ...
    destruct j.
     ...
     destruct s3 as [n3| ].
      ...
      destruct s4 as [n4| ].
       ...
       rewrite carry_indic_I2NN in Hn; [ idtac | assumption ].
       destruct n4; [ rewrite Nat.add_0_r in Ht4; contradiction | idtac ].
   ...
   destruct n.
    ...
    destruct s1 as [di1| ].
     ...
     destruct di1.
      ...
      destruct (lt_dec a (pred radix)) as [H1| H1]; subst a.
       ...
       injection Hx1; clear Hx1; intros Hx1.
    ...
    destruct s1 as [di1| ].
     ...
     destruct di1.
      ...
      rewrite carry_indic_I2NN in H; [ idtac | assumption ].
      injection H; clear H; intros H.
      rewrite d2n_mod_radix, Nat.add_1_r in H.
      rewrite Nat.succ_pred in H; [ idtac | apply radix_neq_0 ].
      rewrite Nat.mod_same in H; [ idtac | apply radix_neq_0 ].
      apply eq_d2n_0 in H.
...
destruct s1 as [n1| ].
 ...
 destruct s2 as [n2| ].
  ...
  rewrite carry_add_inf in Hn; [ idtac | assumption ].
  rewrite Nat.add_1_r in Hn.
  rewrite Nat.succ_pred in Hn; [ idtac | apply radix_neq_0 ].
  injection Hn; clear Hn; intros Hn.
  rewrite Nat.mod_same in Hn; [ idtac | apply radix_neq_0 ].
  symmetry in Hn; simpl in Hn.
 ...
 destruct H as [H1| H1]; rewrite H1 in Hn.
  ...
  rewrite <- d2n_1 in Hn.
  injection Hn; clear Hn; intros Hn.
  rewrite Nat.add_1_r, Nat.succ_pred in Hn; [ idtac | apply radix_neq_0 ].
  rewrite Nat.mod_small in Hn; [ idtac | apply radix_gt_1 ].
  rewrite Nat.mod_same in Hn; [ idtac | apply radix_neq_0 ].
  discriminate Hn.
  ...
  rewrite Nat.mod_small in Hn; [ idtac | apply radix_gt_1 ].
  rewrite Nat.add_0_r, Nat_pred_mod in Hn.
  apply Nat.succ_inj_wd in Hn.
  rewrite succ_pred_radix in Hn; symmetry in Hn.
  rewrite <- radix_2_eq_1_9 in Hy0; [ idtac | assumption ].
  rename Hn into Hr.
...
destruct s1 as [n1| ].
 ...
 destruct s2 as [n2| ].
  ...
  destruct s4 as [n4| ].
   ...
   injection Hn; clear Hn; intros Hn.
   rewrite Nat.mod_0_l in Hn; [ idtac | apply radix_neq_0 ].
   ...
   destruct H as [H1| H1]; rewrite H1 in Hn.
    ...
    destruct n2.
     ...
     rewrite Hx, Hy; unfold d2n; simpl.
    ...
    rewrite <- d2n_1 in Hn.
    injection Hn; clear Hn; intros Hn.
    rewrite Nat.add_1_r, succ_pred_radix in Hn.
    rewrite Nat.mod_same in Hn; [ idtac | apply radix_neq_0 ].
    rewrite Nat.mod_small in Hn; [ idtac | apply radix_gt_1 ].
    discriminate Hn.
    ...
    destruct s3 as [n3| ].
     ...
     destruct s4 as [n4| ].
      ...
      destruct n4.
       ...
       exfalso; apply Ht4.
       apply Nat.succ_inj.
       rewrite H1, Nat.succ_pred; [ reflexivity | apply radix_neq_0 ].
 ...
 destruct s2 as [n2| ].
  ...
  destruct n2.
   ...
   apply I_eq_case_x_0_yn9 with (i := i) in H; try eassumption.
    ...
    intros H1; symmetry in H1; contradiction.
   ...
   injection Hn; clear Hn; intros Hn.
   rewrite add_pred_radix_1_mod_radix in Hn; symmetry in Hn.
   assert (1 ≤ S n2) as HY by apply le_n_S, Nat.le_0_l.
   rewrite <- Nat.add_succ_l in Hn.
   erewrite carry_add_fin in Hn; [ idtac | eassumption | assumption ].
   rewrite carry_indic_I2NN in Hn; [ idtac | assumption ].
   rewrite Nat.add_0_r, d2n_mod_radix in Hn.
...
assert (Some 0 = fst_neq_9 (I2NN x) (S i)) as H3.
 ...
 assert (None = fst_neq_9 (I2NN y) (S i)) as H4.
  ...
  apply Digit.eq_dig_eq.
  rewrite add_pred_radix_1_mod_radix, zero_mod_radix; reflexivity.
Qed.

Theorem eq_999_000 : ∀ x y i,
  (∀ j, j < i → (x .[ j] = y .[ j])%D)
  → d2n (x .[ i]) = d2n (y .[ i]) + 1
  → (∀ di, (x .[ i + S di] = 0)%D ∧ (y .[ i + S di] = 9)%D)
  → (x = y)%I.
Proof.
intros x y i Hj Hxyi Hxy j.
unfold I_norm; simpl.
unfold I2NN at 1; unfold I2NN at 2.
unfold carry_add at 1.
remember (fst_neq_9 (I2NN x) (S j)) as s1 eqn:Hs1 .
destruct s1 as [n1| ].
 symmetry in Hs1.
 rewrite carry_indic_I2NN; [ idtac | assumption ].
 rewrite Nat.add_0_r, n2d_d2n.
 unfold carry_add.
 remember (fst_neq_9 (I2NN y) (S j)) as s2 eqn:Hs2 .
 destruct s2 as [n2| ].
  symmetry in Hs2.
  rewrite carry_indic_I2NN; [ idtac | assumption ].
  rewrite Nat.add_0_r, n2d_d2n.
  destruct (lt_dec j i) as [H1| H1]; [ apply Hj; assumption | idtac ].
  symmetry in Hs2.
  apply first_nonzero_iff in Hs2.
  destruct Hs2 as (Hn2, Ht2).
  pose proof (Hxy n2) as (_, H).
  apply seq_not_9_I2NN_neq, neq_d2n_9 in Ht2.
  rewrite Nat.add_succ_r in H.
  destruct (eq_nat_dec j i) as [H2| H2]; [ subst j; contradiction | idtac ].
  apply Nat.neq_sym in H2.
  apply Nat.nlt_ge in H1.
  apply Nat_le_neq_lt in H1; [ idtac | assumption ].
  rename H into Hy.
  pose proof (Hxy (j - S i + S n2)) as (_, H).
  rewrite Nat.add_succ_r, <- Nat.add_succ_l, Nat.add_assoc in H.
  rewrite Nat.add_sub_assoc in H; [ idtac | assumption ].
  rewrite Nat.add_comm in H; remember (plus (S n2)) as f.
  rewrite Nat.add_comm, Nat.add_sub in H; subst f; simpl in H.
  rewrite Nat.add_comm in H; contradiction.
  ...
  destruct (lt_eq_lt_dec j i) as [[H1| H1]| H1].
   ...
   rewrite Nat.add_sub_assoc in H; [ idtac | assumption ].
   rewrite Nat.add_comm, Nat.add_sub in H.
   rewrite H, Nat.add_1_r, succ_pred_radix in Hxyi; clear H.
   pose proof d2n_lt_radix (x.[i]) as H.
   rewrite Hxyi in H.
   exfalso; revert H; apply Nat.lt_irrefl.

   subst j.
   rewrite n2d_add, n2d_d2n, n2d_1.
   apply digit_d2n_eq_iff.
   rewrite d2n_add, d2n_1.
   rewrite Nat.mod_small; [ assumption| idtac ].
   rewrite <- Hxyi; apply d2n_lt_radix.

   pose proof Hxy (j - S i) as H.
   rewrite Nat.add_succ_r, <- Nat.add_succ_l in H.
   rewrite Nat.add_sub_assoc in H; [ idtac | assumption ].
   rewrite Nat.add_comm, Nat.add_sub in H.
   destruct H as (H2, H3); rewrite H2, H3.
   unfold I_norm; simpl.
   apply Digit.eq_dig_eq.
...
Proof.
intros x y.
apply I_eqs_eq, I_eqs_add2_comm.
Qed.
...
Theorem I_add2_0_r_lemma : ∀ x i,
  first_nonzero (seq_eq (x + 0) x) = Some i
  → (x .[i] ≠ 9)%D
  → d2n ((x + 0)%I .[i]) = d2n (x.[i]) + 1
    ∧ (∀ di : nat, ((x + 0)%I .[i + S di] = 0)%D ∧ (x .[i + S di] = 9)%D).
Proof.
intros x i Hs1 H1.
symmetry in Hs1.
generalize Hs1; intros H.
...
*)
  ...
  apply seq_not_9_I2NN, eq_d2n_9 in H.
  do 2 rewrite Nat.add_succ_r.
  rewrite H, d2n_9, <- Nat.add_succ_r.
  split; [ unfold I_norm; simpl | reflexivity ].
...
destruct s1 as [n1| ].
 ...
 split.
  ...
  destruct n1.
    ...
    destruct (Digit.eq_dec a (x .[ 0])) as [H2| H2].
     ...
     destruct s1 as [n1| ].
      ...
      destruct i.
       ...
       rewrite H1.
       rewrite d2n_9; unfold I_norm, n2d; simpl.
       rewrite add_pred_radix_1_mod_radix, zero_mod_radix.
       reflexivity.
       ...
       unfold I_norm at 1; simpl.
       rewrite add_pred_radix_1_mod_radix, zero_mod_radix.
       split; [ reflexivity | idtac ].
       apply eq_d2n_9; assumption.

    right; left.
    symmetry in Hs1; apply I_add2_0_r_lemma; assumption.

   right; left.
   symmetry in Hs1; apply I_add2_0_r_lemma; [ assumption | idtac ].
   symmetry in Hs1.
   generalize Hs1; intros H.
   apply first_nonzero_iff in H.
   destruct H as (Hn1, Ht1).
   ...
   rewrite carry_add_add_0_r2, NN_add_add_0_r in Ht1.
   unfold I2NN at 1 in Ht1; simpl in Ht1.
   unfold carry_add in Ht1.
   remember (fst_neq_9 (I2NN x) (S (S n1))) as s2 eqn:Hs2 .
   destruct s2 as [n2| ].
    symmetry in Hs2.
    rewrite carry_indic_I2NN in Ht1; [ idtac | assumption ].
    rewrite Nat.add_0_r in Ht1.
    ...
    clear Ht1.
    pose proof (Hn1 n1 (Nat.lt_succ_diag_r n1)) as H.
    apply seq_eq_eq in H; simpl in H.
    rewrite carry_add_add_0_r2, NN_add_add_0_r in H.
    unfold I2NN at 1 in H.
    unfold carry_add in H; simpl in H.
    remember (fst_neq_9 (I2NN x) (S n1)) as s3 eqn:Hs3 .
    destruct s3 as [n3| ].
     clear H.
     apply first_nonzero_iff in Hs3.
     destruct Hs3 as (Hn3, Ht3).
     destruct n3.
      ...
      rewrite Nat.add_0_r in Ht3.
      unfold I2NN in Ht3.
      apply neq_d2n_9 in Ht3; assumption.

      generalize Hs2; intros H.
      apply first_nonzero_iff in H.
      rename H into Hn2.
      pose proof (Hn2 n3) as H.
      apply seq_not_9_neq in Ht3.
      apply seq_not_9_eq in H.
      rewrite Nat.add_succ_r in Ht3; contradiction.
     ...
     destruct (Digit.eq_dec (x .[ n1]) 9) as [H2| H2].
      rewrite H2, d2n_9 in H.
      rewrite add_pred_radix_1_mod_radix in H.
      exfalso; symmetry in H; revert H; apply pred_radix_neq_0.

      rewrite Nat.mod_small in H.
       apply Nat.add_sub_eq_l in H.
       rewrite Nat.sub_diag in H; discriminate H.

       rewrite Nat.add_1_r.
       apply Nat_le_neq_lt; [ apply d2n_lt_radix | idtac ].
       clear H; intros H; apply H2.
...
rewrite <- Nat.add_mod_idemp_r; [ symmetry | apply radix_neq_0 ].
rewrite <- Nat.add_mod_idemp_r; [ symmetry | apply radix_neq_0 ].
      ...
      destruct (lt_dec a (pred radix)) as [H1| H1]; subst a.
       ...
       destruct s3 as [n3| ].
        ...
        destruct (lt_dec a (pred radix)) as [H2| H2]; subst a.
         ...
         rewrite Nat.add_shuffle0, Nat.add_1_r, succ_pred_radix.
         rewrite n2d_add, n2d_d2n; unfold I_norm; simpl.
         rewrite Nat.add_comm.
         rewrite Nat_mod_add_once; [ reflexivity | apply radix_neq_0 ].
       ...
       apply Nat.nlt_ge in H1.
       exfalso; revert Hxy Hs2 H1; clear; intros.
       apply first_nonzero_iff in Hs2.
       destruct Hs2 as (Hn2, Ht2).
       unfold seq_not_9 in Ht2; simpl in Ht2.
       unfold NN_add, I2NN in Ht2; simpl in Ht2.
       pose proof Hxy (S (j + n2)) as (H, _).
       apply eq_d2n_0 in H; rewrite H in Ht2; simpl in Ht2.
       remember (d2n (z .[ S (j + n2)])) as a.
       destruct (eq_nat_dec a (pred radix)) as [H2| H2]; subst a.
        apply Ht2; reflexivity.

        apply H2; clear H2; symmetry.
        apply Nat.le_antisymm; [ assumption | apply le_d2n_9 ].
...
rewrite Nat.add_0_r in H.
        unfold NN_add, I2NN in H; simpl in H.
        pose proof Hxy (S j) as (H1, _).
        apply eq_d2n_0 in H1; rewrite H1 in H; clear H1; simpl in H.
remember (d2n (z.[S j])) as a.
destruct (eq_nat_dec a (pred radix)) as [H1|H1]; subst a.
clear H.
apply first_nonzero_iff in Hs1.
destruct Hs1 as (Hn1, Ht1).
generalize Hj; intros H2.
apply le_n_S, Hn1 in H2.
unfold seq_end_with_999 in H2.
remember (fst_neq_9 (I2NN z) j) as s4 eqn:Hs4.
destruct s4 as [n4| ]; [clear H2|discriminate H2].
generalize Hs4; intros H2.
apply first_nonzero_iff in H2.
destruct H2 as (Hn4, Ht4).
destruct n4.
apply seq_not_9_I2NN_neq in Ht4.
rewrite Nat.add_0_r in Ht4.
clear Hn4.
...
apply Nat.mul_le_mono_r, radix_gt_0.
Qed.
...
Proof.
intros x i Hs1; symmetry in Hs1.
apply first_nonzero_iff in Hs1.
assert (∀ j, (NN2I_add (I2NN x) .[ i + j] = 9)%D) as Hi.
 intros j.
 pose proof (Hs1 j) as H.
 apply seq_not_9_I2NN in H.
 apply eq_d2n_9; assumption.

 assert (∀ j, (x .[ i + j] = 9)%D) as Hx.
  intros j.
  ...
  unfold carry_add in H; simpl in H.
  remember (fst_neq_9 (I2NN x) (S (i + j))) as s2 eqn:Hs2 .
  destruct s2 as [n2| ].
   symmetry in Hs2.
  ...
  pose proof (Hi 0) as Hn.
  pose proof (Hx 0) as H.
  apply eq_d2n_9 in H.
  rewrite Nat.add_0_r in Hn, H.
  unfold I_norm in Hn; simpl in Hn.
  unfold I2NN at 1 in Hn.
  rewrite H, Nat_pred_mod in Hn.
  unfold carry_add in Hn; simpl in Hn.
  remember (fst_neq_9 (I2NN x) (S i)) as s2 eqn:Hs2 .
  destruct s2 as [n2| ].
   apply first_nonzero_iff in Hs2.
   destruct Hs2 as (Hn2, Ht2).
   apply seq_not_9_I2NN_neq, neq_d2n_9 in Ht2.
   clear H; pose proof (Hx (S n2)) as H.
   rewrite Nat.add_succ_r in H; contradiction.

   rewrite add_pred_radix_1_mod_radix in Hn.
   symmetry in Hn; revert Hn; apply pred_radix_neq_0.
Qed.
...
destruct s1 as [n1| ].
 ...
 rewrite carry_indic_I2NN; [ idtac | assumption ].
 rewrite Nat.add_0_r.
 rewrite Nat.mod_mod; [ reflexivity | apply radix_neq_0 ].

 exfalso; symmetry in Hs1; revert Hs1.
 apply fst_neq_9_I2NN.
Qed.
...
do 2 rewrite Nat.add_assoc.
unfold I_norm, n2d; rewrite <- Hr; simpl.
pose proof radix_neq_0 as Hr0; rewrite <- Hr in Hr0.
pose proof radix_gt_0 as Hrp; rewrite <- Hr in Hrp.
...
unfold NN2I; fsimpl.
rewrite Nat.mul_1_r.
unfold I_norm; fsimpl.
do 2 (rewrite Nat.mod_mod; [ idtac | apply radix_neq_0 ]).
...
eapply le_lt_trans with (m := radix * pred radix).
 ...
 apply Nat.mul_lt_mono_pos_l; [ apply radix_gt_0 | idtac ].
...
rewrite Nat.div_add; [ idtac | apply radix_neq_0 ].
rewrite Nat.div_small; [ reflexivity | idtac ].
...
replace radix with (1 * radix) in Hc by apply Nat.mul_1_l.
rewrite Hc, Nat.add_comm.
rewrite Nat.mod_add; [ idtac | apply radix_neq_0 ].
...
do 5 (rewrite Nat.mod_mod; [ idtac | apply radix_neq_0 ]).
...
rewrite <- Nat.add_mod_idemp_l; [ symmetry | apply radix_neq_0 ].
rewrite <- Nat.add_mod_idemp_l; [ symmetry | apply radix_neq_0 ].
f_equal; f_equal.
Set Printing Depth 12. Show.
rewrite Nat.add_mod; [ symmetry | apply radix_neq_0 ].
...
remember (r * r) as rr.
Set Printing Depth 11. Show.
do 2 (rewrite Nat.add_mod; [ symmetry | apply radix_neq_0 ]).
...
erewrite summation_compat.
 ...
 erewrite summation_compat.
  ...
  rewrite Nat.add_mod in Hb; [ idtac | apply radix_neq_0 ].
  symmetry.
  rewrite Nat.add_mod; [ idtac | apply radix_neq_0 ].
  symmetry; subst b.
  rewrite Nat.add_mod_idemp_l; [ idtac | apply radix_neq_0 ].
...
do 6 rewrite d2n_n2d.
do 4 rewrite <- Nat.add_assoc; simpl.
do 6 (rewrite Nat.mod_mod; [ idtac | apply radix_neq_0 ]).
...
do 8 (rewrite Nat.div_mul_cancel_r; try apply radix_neq_0).
rewrite Nat.mod_0_l; [ idtac | apply radix_neq_0 ].
...
rewrite Nat_lt_sqr_div_mod.
 ...
 rewrite Nat_lt_sqr_div_mod.
  ...
  rewrite lt_radix_div_add_sqr_radix.
   ...
   2: apply Nat.mod_upper_bound, radix_neq_0.
      ...
      destruct (lt_dec (yi1 + zi1) radix) as [H3| H3].
       ...
       destruct (lt_dec (xi1 + yi1) radix) as [H4| H4].
        ...
        destruct (eq_nat_dec ((xi + yi + zi) mod radix) (pred radix))
         ...
         rewrite Nat_sub_div.
          2: split;
              [ apply radix_gt_0 | revert H4; clear; intros; omega ].

          rewrite Nat.add_comm.
          rewrite Nat.add_pred_l; [ idtac | apply radix_neq_0 ].
          ...
          rewrite <- Nat.add_pred_l.
           ...
           rewrite Nat.div_add in H; [ idtac | apply radix_neq_0 ].
