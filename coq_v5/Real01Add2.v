   ...
   destruct n.
    ...
    destruct s1 as [di1| ].
     ...
     destruct di1.
      ...
      symmetry in H.
      rewrite <- Nat.add_succ_l in H.
      rewrite seq_pred_r_d2n in H; [ idtac | assumption ].
      rewrite <- Nat.add_succ_r in H.
      rewrite carry_add_inf in H; [ idtac | assumption ].
      symmetry in H, Hs1.
           ...
           destruct j.
            ...
            destruct s3 as [n3| ].
             ...
             destruct s4 as [n4| ].
              ...
              destruct H as (Hx, Hy).
              apply eq_d2n_0 in Hx; rewrite Hx in Hn.
              apply eq_d2n_pred_radix in Hy; rewrite Hy in Hn.
          ...
          destruct s2 as [n2| ].
           ...
           destruct (lt_dec a (pred radix)) as [H6| H6]; subst a.
            destruct n2.
             ...
             apply eq_d2n_pred_radix in H3; rewrite H3 in H6.
             ...
             erewrite carry_add_fin in Hn; [ idtac | eassumption | idtac ].
              ...
              destruct (lt_dec a (pred radix)) as [H7| H7]; subst a.
               ...
               remember (fst_neq_pred_r (I2NN x) (S (S i))) as s3 eqn:Hs3 .
               destruct s3 as [n3| ].
          ...
          destruct di.
           ...
           destruct s3 as [n3| ].
            ...
            destruct n3; [ clear Hn3 | idtac ].
             ...
             remember (fst_neq_pred_r (I2NN x) a) as s4 eqn:Hs4 ; subst a.
             destruct s4 as [n4| ].
              generalize Hs4; intros H.
              apply first_nonzero_iff in H; simpl in H.
              destruct H as (Hn4, Ht4).
...
(*
          destruct di.
*)
           pose proof (Hxy di) as Hn.
           unfold digit_eq in Hn; simpl in Hn.
           unfold I2NN in Hn at 1; simpl in Hn.
           unfold I2NN in Hn at 2; simpl in Hn.
(*
           rewrite H3, H4 in Hn; simpl in Hn.
*)
           unfold carry_add in Hn.
           remember (fst_neq_pred_r (I2NN x) (S di)) as s1 eqn:Hs1 .
           remember (fst_neq_pred_r (I2NN y) (S di)) as s2 eqn:Hs2 .
           destruct s1 as [n1| ].
            symmetry in Hs1.
            rewrite carry_indic_I2NN in Hn; [ idtac | assumption ].
            destruct s2 as [n2| ].
              symmetry in Hs2.
             rewrite carry_indic_I2NN in Hn; [ idtac | assumption ].
do 2 rewrite Nat.add_0_r, d2n_mod_radix in Hn.
apply digit_d2n_eq_iff in Hn.
destruct di; [contradiction|idtac ].
pose proof IHdi di (Nat.lt_succ_diag_r di) as H.
destruct H as (Hy, Hx).
rewrite Hx, Hy in Hn; symmetry in Hn.
exfalso; revert Hn; apply Digit.neq_0_1.
             ...
             apply first_nonzero_iff in H; simpl in H.
             rename H into Hn2.
             pose proof (Hn2 0) as H; simpl in H.
             apply seq_pred_r_I2NN, eq_d2n_pred_radix in H; simpl in H.
             rewrite radix_2_eq_pred_r_1 in H; [|assumption].
             rewrite Nat.add_0_r in H; rename H into Hy.
             clear Hn; pose proof (Hxy (S di)) as Hn.
             unfold digit_eq in Hn; simpl in Hn.
             unfold I2NN in Hn at 1; simpl in Hn.
             unfold I2NN in Hn at 2; simpl in Hn.
             apply -> digit_d2n_eq_iff in Hy.
             ...
             rewrite <- Nat.add_1_r in Hn; subst one.
             symmetry in Hs2.
             rewrite carry_add_inf in Hn; [ idtac | assumption ].
             rewrite Nat.add_1_r in Hn.
             rewrite <- H6 in Hn.
             rewrite Nat.mod_same in Hn; [ idtac | assumption ].
             unfold carry_add in Hn.
             remember (fst_neq_pred_r (I2NN x) (S di + 1)) as s3 eqn:Hs3 .
             destruct s3 as [n3| ].
              symmetry in Hs3.
              rewrite carry_indic_I2NN in Hn; [ idtac | assumption ].
              rewrite Nat.add_0_r, d2n_mod_radix in Hn.
...
pose proof IHdi di (Nat.lt_succ_diag_r di) as H.
destruct H as (Hy, Hx).
apply eq_d2n_pred_radix in Hx; rewrite Hx in Hn.
apply eq_d2n_0 in Hy; rewrite Hy in Hn.
simpl in Hn.
unfold carry_add in Hn.
         remember (fst_neq_pred_r (I2NN x) (S (S di))) as s1 eqn:Hs1 .
         remember (fst_neq_pred_r (I2NN y) (S (S di))) as s2 eqn:Hs2 .
destruct s1 as [n1|].
symmetry in Hs1.
...
destruct di.
unfold carry_add in Hn.
         remember (fst_neq_pred_r (I2NN x) (1)) as s3 eqn:Hs3 .
         remember (fst_neq_pred_r (I2NN y) (1)) as s4 eqn:Hs4 .
destruct s3 as [n3|].
symmetry in Hs3.
rewrite carry_indic_I2NN in Hn;[|assumption].
rewrite Nat.add_0_r, d2n_mod_radix in Hn.
...
apply seq_pred_r_I2NN in H; simpl in H.
rewrite Hy, H6 in H; discriminate H.
symmetry in Hs1.
apply first_nonzero_iff in Hs1.
...
apply seq_pred_r_I2NN in H.
contradiction.
assert (di < S (S di)) as H by omega.
apply IHdi in H.
destruct H as (Hyi, Hxi).
apply eq_d2n_pred_radix in Hxi.
apply eq_d2n_0 in Hyi.
rewrite Hxi, Hyi in Hn; simpl in Hn.
