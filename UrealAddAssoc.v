...
Theorem rad_2_sum_3_all_9_0_1_222_3 {r : radix} : ∀ u i j,
  rad = 2
  → (∀ k, u (i + k) ≤ 3 * (rad - 1))
  → (∀ k, fA_ge_1_ε u i k = true)
  → u (i + 1) = 0
...
Proof.
intros * Hr2 Hu3r Hau Hu1 Huj Huj2.
...
assert (Hcu1 : carry u (i + 1) = 1). {
  ...
  rewrite Hu1, Nat.add_0_l, Hr2 in Hpu1.
...
assert (Hcu2 : carry u (i + j + 2) = 2 * ((carry u (i + j + 2) + 1) / 2)). {
...
apply rad_2_sum_3_all_9_0_1_222_3; try easy.
