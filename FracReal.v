...
(* perhaps it works when u(i+1)=rad-2 *)
...
...
destruct (lt_dec (u (i + 1)) (rad - 2)) as [H3| H3].
-specialize (nA_upper_bound_for_add_3 u i n Hur H3 His) as H2.
 ...
 flia.
-assert (H2 : u (i + 1) = rad - 2) by flia H1 H3.
 clear H1 H3.
...
Qed.
